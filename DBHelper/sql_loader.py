# -*- coding:utf-8 -*-
# Auther: miaokl
# Date: 2023-01-18 12:58:42
# Description: yml存放sql语句，根据sql_id来读取指定yml文件下对应key的sql
import os
import typing
...
class g:  # Web端可以设置一个接口重置该值，刷新sql的修改
    sql_dict = {}
...
if __name__ == '__main__':
    sl = SqlLoader()
    ret = sl.preload_sql("home_page.sensor.selectAll", options={"equipment_id": 1})
    print(ret)
